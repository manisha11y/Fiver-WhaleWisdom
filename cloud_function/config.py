    ...
    holdings_schema=[
        ...
        bigquery.SchemaField(
            ...
            fields=[
                ...
                bigquery.SchemaField("date_last_filed",	"DATE",	mode="NULLABLE"),
                bigquery.SchemaField(
                "holdings",
                "RECORD",
                mode="REPEATED",
                fields=[
                    bigquery.SchemaField("quarter_id_owned",	"INTEGER",	mode="NULLABLE"),
                    bigquery.SchemaField("percent_change",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("avg_price",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("filer_state",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("source_date",	"DATE",	mode="NULLABLE"),
                    bigquery.SchemaField("stock_id",	"INTEGER",	mode="NULLABLE"),
                    bigquery.SchemaField("previous_shares",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("current_shares",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("shares_change",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("source",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("previous_mv",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("current_percent_of_portfolio",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("previous_percent_of_portfolio",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("current_mv",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("previous_ranking",	"INTEGER",	mode="NULLABLE"),
                    bigquery.SchemaField("filer_city",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("filer_street_address",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("percent_ownership",	"FLOAT",	mode="NULLABLE"),
                    bigquery.SchemaField("filer_zip_code",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("sector",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("current_ranking",	"INTEGER",	mode="NULLABLE"),
                    bigquery.SchemaField("industry",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("position_change_type",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("security_type",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("stock_ticker",	"STRING",	mode="NULLABLE"),
                    bigquery.SchemaField("filer_id",	"INTEGER",	mode="NULLABLE"),
